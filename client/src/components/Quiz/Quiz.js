...
class Quiz extends Component {
    ...
    componentDidMount() {
        ...
        fetch(API)
            ...
            .then(result =>
                setTimeout(() => this.setData(result.results), 1000)
            )
    ...
    setData(results) {
        ...
        const outPut = randomNumbers(0, 3);
    ...
    handleNext() {
        ...
        let point = 0;
        if (
            userSlectedAns === he.decode(quizData[questionIndex].correct_answer)
        ) {
            point = 1;
        }
        ...
        return (
            <Item.Header>
                ...
                {quizIsCompleted && !resultRef && (
                    <Loader text="Obtendo seu resultado." />
                )}
